...
function NS_UA_WS() {
  ...
  this.checkReady = function() {
    if (this.dataManagerReady && this.msgBrokerReady) {
      Log.debug('NS_UA_WS::checkReady --> Clearing readyTimeout');
  ...
  this.subscribeQueues = function(broker) {
    var args = {
      durable: false,
      autoDelete: true,
      arguments: {
    ...
    MsgBroker.subscribe(process.serverId, args, broker, function(message) {
  ...
  // HTTP callbacks
  //////////////////////////////////////////////
  this.onHTTPMessage = function(request, response) {
  ...
  // WebSocket callbacks
  //////////////////////////////////////////////
  this.onWSRequest = function(request) {
    // Common variables
    var self = this;
  ...
  this.getPendingMessages = function(uaid, callback) {
  ...
  this.recoveryChannels = function(uaid, channelIDs) {
